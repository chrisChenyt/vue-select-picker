...
*/
<template>
  <div class="h-picker" v-show="show" @click="bgClose">
    <transition name="fade">
      <div id="area_ctrl" class="area_ctrl" v-if="isOpened > 0" v-show="show">
        <div class="area_btn_box">
          <div class="area_btn larea_cancel" @click="close">取消</div>
          <div class="area_title">{{titleText}}</div>
...
<script>
  export default {
    ...
    methods: {
      ...
      bgClose () {
        var sp = document.getElementById("area_ctrl");
        if(sp){
...
.area_ctrl {
  ...
  -webkit-box-shadow: 0 -4px 8px 0 #F0F0F0;
}
